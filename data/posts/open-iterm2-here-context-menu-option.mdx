...
publishedOn: '2016-10-07'
summary: 'Add a finder context menu item for opening terminals in MacOS'
---
...
![Screenshot](/static/images/open-iterm2-here-context-menu-option/1.png)

2) For the _Service receives selected_ field, select _Folders_. 

![Screenshot](/static/images/open-iterm2-here-context-menu-option/2.png)

3) Drag _Run AppleScript_ onto the right hand window to add some of the AppleScript code that will power the service.

![Screenshot](/static/images/open-iterm2-here-context-menu-option/3.png)
...
![Screenshot](/static/images/open-iterm2-here-context-menu-option/4.png)
